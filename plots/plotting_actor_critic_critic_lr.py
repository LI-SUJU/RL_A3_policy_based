...
ax.legend()
# add title
plt.title("Actor-critic with different critic learning rates", fontsize = 15, y=1.05)
# add subtitle and make it under the title
plt.suptitle("entropy coefficient=0.05, policy lr=0.0005, baseline, boostrapping", fontsize = 10, y=0.92)
