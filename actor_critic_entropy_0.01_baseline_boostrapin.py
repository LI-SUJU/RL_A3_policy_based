...
# Implementation
def train_actor_critic(env, policy_net, policy_optimizer, value_net, value_optimizer, gamma=0.99, n=100, entropy_coef=0.01):
    """
...
np.save(os.path.join(directory, "returns_actor-critic_entropy-0.01_baseline_boostrapping.npy"), returns)
