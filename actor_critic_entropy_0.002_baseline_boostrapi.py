...
# Implementation
def train_actor_critic(env, policy_net, policy_optimizer, value_net, value_optimizer, gamma=0.99, n=100, entropy_coef=0.002):
    """
...
np.save(os.path.join(directory, "returns_actor-critic_entropy-0.002_baseline_boostrapping.npy"), returns)
