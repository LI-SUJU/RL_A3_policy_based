...
def train_REINFORCE_baseline_entropy(env, policy_net, policy_optimizer, value_net, value_optimizer, gamma=0.99, entropy_coef=0.01):
    """
...
np.save(os.path.join(directory, "returns_reinforcement_baseline_entropy_0.01.npy"), returns)
