...
def train_REINFORCE(env, policy_net, policy_optimizer, gamma=0.99):
    """
...
for i in tqdm.tqdm(range(num_seeds)):
    ...
    # Save the data of array returns into the directory
...
np.save(os.path.join(directory, "returns_reinforcement.npy"), returns)
